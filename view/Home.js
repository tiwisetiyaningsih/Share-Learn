            ...
            <View style={style.home}>
                ...
                <ScrollView>
                    {this.state.listPost.map((item, index) => {
                        ...
                        return <PostRecommentImage navigation={this.props.navigation} OpenModal={this.OpenModal} key={index} data={item}></PostRecommentImage>
                    })}
...
const PostRecommentPdf = ({ navigation, OpenModal, data }) => (
...
const PostRecommentImage = ({ navigation, OpenModal, data }) => (
    <View style={{ backgroundColor: '#FFF', paddingHorizontal: 20, paddingTop: 20, marginBottom: 4, elevation: 1 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            <View style={{ flexDirection: 'row', alignContent: 'center' }}>
                <BaseButton
        ...
        <View style={{ alignItems: 'center' }}>
            <Image source={{uri: Constant.api_url + data.file_post} } style={{ width: 370, height: 370 }}></Image>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 8 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ paddingVertical: 10, flexDirection: 'row', alignItems: 'center' }}>
