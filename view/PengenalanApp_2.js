...
const Body = ({ navigation }) => (
    <View style={{ justifyContent: 'flex-end' }}>
        <View style={{ alignItems: 'center', backgroundColor: '#38C6C6', borderTopLeftRadius: 16, borderTopRightRadius: 16, borderTopColor: '#AAA', borderTopWidth: 2, elevation: 5, padding: 20 }}>
            <Text style={{ color: '#FFFFFF', fontFamily: 'Inter-Bold', fontSize: 32, marginTop: 20 }}>Download</Text>
            <Text style={{ color: '#FFFFFF', fontFamily: 'Inter-Bold', fontSize: 20, paddingTop: 40, justifyContent: 'center' }}>Used to save learning materials</Text>
