...
const PostRecommentPdf = ({ navigation }) => (
    <View style={{ backgroundColor: '#FFF', paddingHorizontal: 20, paddingTop: 20, marginBottom: 1, elevation: 1 }}>
...
const ListComment = () => (
    <View style={{ backgroundColor: '#FFF', paddingHorizontal: 20, paddingTop: 10, marginBottom: 3, elevation: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            <BaseButton
                onPress={() => { navigation.navigate('profile') }}>
                <Image source={require('../assets/logo/user_profile.png')}></Image>
