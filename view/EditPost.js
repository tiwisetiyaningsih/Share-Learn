    ...
    render() {
        return (
            <View style={style.app}>
                ...
                <FormEditPost navigation={this.props.navigation} OpenModal={this.OpenModal} OpenModal1={this.OpenModal1}></FormEditPost>
...
const FormEditPost = ({ navigation, OpenModal, OpenModal1 }) => (
